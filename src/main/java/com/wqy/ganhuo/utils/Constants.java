...
public class Constants {
    public static final String TAG = "ganhuo";
    public static final String DB_NAME = "ganhuo_db";
    public static final String ANDROID_REQUEST_URL = "http://gank.avosapps.com/api/data/Android/";
